...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{route('listing-fee.store')}}" class="needs-validation" method="POST">
          @csrf
        ...
        <div class="modal-content">
            ...
            <form action="{{route('listing-fee.store')}}" class="needs-validation" method="post">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    <label>Nama Item</label>
                    <input type="text" class="form-control" name="item" required value="{{$item->item}}">
                    <div class="invalid-feedback">
                      Something Else
                    </div>
                  </div>
...
<div class="modal fade" id="modalDelete_{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('listing-fee.destroy',$item->id) }}" method="post">
          @method('DELETE')
          @csrf
          <input type="hidden" name="id" id="id" value="{{ $item->id }}">
          <div class="modal-body">
            Anda yakin ingin menghapus Data <b>{{ $item->item }}</b>
          </div>
          <div class="modal-footer">
