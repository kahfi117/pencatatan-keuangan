    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Data Pemasukan Non Tunai</h1>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-12 col-md-6 col-lg-6">
                                    <h4>Data Pamasukan Non Tunai</h4>
                                </div>
                                    ...
                                    <table class="table-striped table" id="table-1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Mandiri/Ovo</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">Rp.{{number_format($item->nominal_bni, 2,',','.')}}</td>
                                                <td class="text-right">Rp.{{number_format($item->nominal_mandiri, 2,',','.')}}</td>
                                                <td class="text-right">Rp.{{number_format($item->nominal_mandiri + $item->nominal_bni, 2,',','.')}}</td>
                                                <td class="text-center">
        ...
        @include('contents.nontunai.modal')
    </div>
@endsection
